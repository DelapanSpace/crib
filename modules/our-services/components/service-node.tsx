...
export const ServiceNode = memo(({ data, isConnectable, selected }: NodeProps) => {
    ...
    <div className="relative group">
      ...
      <Card 
        className={cn(
          ...
          isOpen ? "border-zinc-600 text-zinc-100 shadow-2xl shadow-black/50" : "h-[70px]",
        ...
        <CardHeader className="p-5 flex flex-row items-center justify-between space-y-0 pb-0">
          <div className="flex items-center gap-3">
            ...
            <div className={cn(
              ...
              isSource ? "bg-white animate-pulse" : (isOpen ? "bg-white shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-zinc-800")
            )} />
          ...
          {isOpen && <Activity className="w-4 h-4 text-zinc-600 animate-pulse" />}
        </CardHeader>
